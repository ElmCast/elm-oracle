...
Elm.Console.make = function (_elm) {
   ...
   $Task = Elm.Task.make(_elm);
   var _op = {};
   var fatal = function (value) {    return $Native$Console.fatal(value);};
   var error = function (value) {    return $Native$Console.error(value);};
   var log = function (value) {    return $Native$Console.log(value);};
   return _elm.Console.values = {_op: _op,log: log,error: error,fatal: fatal};
};
Elm.Native = Elm.Native || {};
...
Elm.File.make = function (_elm) {
   "use strict";
   _elm.File = _elm.File || {};
   if (_elm.File.values) return _elm.File.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   $Task = Elm.Task.make(_elm);
   var _op = {};
   var lstat = function (path) {    return $Native$File.lstat(path);};
   var Stat = {};
   var write = F2(function (path,data) {    return A2($Native$File.write,path,data);});
   var read = function (path) {    return $Native$File.read(path);};
   var WriteError = function (a) {    return {ctor: "WriteError",_0: a};};
   var ReadError = function (a) {    return {ctor: "ReadError",_0: a};};
   return _elm.File.values = {_op: _op,read: read,write: write,lstat: lstat,ReadError: ReadError,WriteError: WriteError};
};
Elm.Native = Elm.Native || {};
...
Elm.Http.make = function (_elm) {
   ...
   $Task = Elm.Task.make(_elm);
   var _op = {};
   var sendResponse = F2(function (response,s) {    return $Task.succeed(A2($Native$Http.response_end,response,s));});
   var getURL = $Native$Http.get_url;
   var serve = F2(function (prt,taskFunction) {    return A2($Native$Http.serve,prt,taskFunction);});
   var get = function (url) {    return $Native$Http.get(url);};
   var Response = {ctor: "Response"};
   var Request = {ctor: "Request"};
   var NetworkError = function (a) {    return {ctor: "NetworkError",_0: a};};
   return _elm.Http.values = {_op: _op,get: get,serve: serve,getURL: getURL,sendResponse: sendResponse,NetworkError: NetworkError};
};
Elm.Native.Regex = {};
...
Elm.Import.make = function (_elm) {
   ...
   $String = Elm.String.make(_elm);
   var _op = {};
   var search = function (file) {
      var pattern = $Regex.regex("(?:^|\\n)import\\s([\\w\\.]+)(?:\\sas\\s(\\w+))?(?:\\sexposing\\s*\\(((?:\\s*(?:\\w+|\\(.+\\))\\s*,)*)\\s*((?:\\.\\.|\\w+|\\(.+\\)))\\s*\\))?");
      return A3($Regex.find,$Regex.All,pattern,file);
   };
   var exposes = function (s) {    return _U.eq(s,"") ? $Maybe.Nothing : $Maybe.Just(A2($List.map,$String.trim,A2($String.split,",",s)));};
   var join = function (mx) {    var _p0 = mx;if (_p0.ctor === "Just") {    return _p0._0;} else {    return $Maybe.Nothing;}};
   var process = function (submatches) {
      var submatches$ = $Array.fromList(submatches);
      var name = A2($Maybe.withDefault,"",join(A2($Array.get,0,submatches$)));
      var alias = join(A2($Array.get,1,submatches$));
      var exposedStart = A2($Maybe.withDefault,"",join(A2($Array.get,2,submatches$)));
      var exposedEnd = A2($Maybe.withDefault,"",join(A2($Array.get,3,submatches$)));
      var exposed = exposes($String.trim(A2($Basics._op["++"],exposedStart,exposedEnd)));
      return {name: name,alias: alias,exposed: exposed};
   };
   var Every = {ctor: "Every"};
   var Some = function (a) {    return {ctor: "Some",_0: a};};
   var None = {ctor: "None"};
   var Import = F2(function (a,b) {    return {alias: a,exposed: b};});
   var toImport = function (_p1) {
      var _p2 = _p1;
      var exposedSet = function () {
         ...
         if (_p3.ctor === "Nothing") {
               ...
               if (_p3._0.ctor === "::" && _p3._0._0 === ".." && _p3._0._1.ctor === "[]") {
                     return Every;
                  } else {
                     return Some($Set.fromList(_p3._0));
                  }
            }
      }();
      return {ctor: "_Tuple2",_0: _p2.name,_1: A2(Import,_p2.alias,exposedSet)};
   };
   ...
   var defaultImports = $Dict.fromList(_U.list([A2(_op["=>"],"Basics",Every)
                                               ...
                                               ,A2(_op["=>"],"Signal",Some($Set.singleton("Signal")))]));
   var imports = function (rawImports) {
      var toDict = function (list) {    return A2($Dict.union,$Dict.fromList(A2($List.map,toImport,list)),defaultImports);};
      return toDict(rawImports);
   };
   var parse = function (source) {    return imports(A2($List.map,process,A2($List.map,function (_) {    return _.submatches;},search(source))));};
   return _elm.Import.values = {_op: _op,parse: parse,Import: Import,None: None,Some: Some,Every: Every};
};
Elm.Native.Json = {};
...
Elm.Path.make = function (_elm) {
   "use strict";
   _elm.Path = _elm.Path || {};
   if (_elm.Path.values) return _elm.Path.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   var extname = function (path) {    return $Native$Path.extname(path);};
   var basename = F2(function (path,ext) {    return A2($Native$Path.basename,path,ext);});
   var dirname = function (path) {    return $Native$Path.dirname(path);};
   var relative = F2(function (from,to) {    return A2($Native$Path.relative,from,to);});
   var isAbsolute = function (path) {    return $Native$Path.isAbsolute(path);};
   var resolve = function (paths) {    return $Native$Path.resolve(paths);};
   var join = function (paths) {    return $Native$Path.join(paths);};
   var normalize = function (path) {    return $Native$Path.normalize(path);};
   return _elm.Path.values = {_op: _op
                             ,normalize: normalize
                             ,join: join
                             ,resolve: resolve
                             ,isAbsolute: isAbsolute
...
Elm.Process.make = function (_elm) {
   ...
   if (_elm.Process.values) return _elm.Process.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   var exit = function (code) {    return $Native$Process.exit(code);};
   var exec = function (command) {    return $Native$Process.exec(command);};
   var execArgv = $Native$Process.execArgv;
   var execPath = $Native$Process.execPath;
   var args = A2($List.drop,2,$Native$Process.argv);
   var argv = $Native$Process.argv;
   return _elm.Process.values = {_op: _op,args: args,argv: argv,execPath: execPath,execArgv: execArgv,exec: exec,exit: exit,pid: pid,version: version};
};
Elm.Native = Elm.Native || {};
...
Elm.Url.make = function (_elm) {
   "use strict";
   _elm.Url = _elm.Url || {};
   if (_elm.Url.values) return _elm.Url.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   $String = Elm.String.make(_elm);
   var _op = {};
   var join = function (paths) {    return A2($String.join,"/",paths);};
   var resolve = function (paths) {    return $Native$Url.resolve(paths);};
   return _elm.Url.values = {_op: _op,resolve: resolve,join: join};
};
Elm.Package = Elm.Package || {};
Elm.Package.make = function (_elm) {
   "use strict";
   _elm.Package = _elm.Package || {};
   if (_elm.Package.values) return _elm.Package.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var Vs = F3(function (a,b,c) {    return {name: a,comment: b,signature: c};});
   var Values = F3(function (a,b,c) {    return {aliases: a,types: b,values: c};});
   var Module = F3(function (a,b,c) {    return {packageName: a,name: b,values: c};});
   var $package = function (packageName) {
      var v = A4($Json$Decode.object3,
      Vs,
      ...
      var name = A2($Json$Decode._op[":="],"name",$Json$Decode.string);
      var type$ = A3($Json$Decode.object2,
      F2(function (v0,v1) {    return {ctor: "_Tuple2",_0: v0,_1: v1};}),
      name,
      A2($Json$Decode._op[":="],"cases",$Json$Decode.list(A3($Json$Decode.tuple2,$Basics.always,$Json$Decode.string,$Json$Decode.value))));
      var values = A4($Json$Decode.object3,
      Values,
      A2($Json$Decode._op[":="],"aliases",$Json$Decode.list(v)),
      A2($Json$Decode._op[":="],"types",$Json$Decode.list(type$)),
      A2($Json$Decode._op[":="],"values",$Json$Decode.list(v)));
      return $Json$Decode.list(A3($Json$Decode.object2,Module(packageName),name,values));
   };
   var decode = function (_p0) {
      var _p1 = _p0;
      var _p2 = A2($Json$Decode.decodeString,$package(_p1._0),_p1._1);
      if (_p2.ctor === "Ok") {
            return _p2._0;
         } else {
            return _U.list([]);
   ...
   var parse = function (input) {    return $List.concat(A2($List.map,decode,input));};
   return _elm.Package.values = {_op: _op,parse: parse,Module: Module};
};
Elm.Oracle = Elm.Oracle || {};
Elm.Oracle.make = function (_elm) {
   "use strict";
   _elm.Oracle = _elm.Oracle || {};
   if (_elm.Oracle.values) return _elm.Oracle.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Dict = Elm.Dict.make(_elm),
   ...
   var encodeInfo = function (info) {
      return $Json$Encode.object(_U.list([{ctor: "_Tuple2",_0: "name",_1: $Json$Encode.string(info.name)}
                                         ,{ctor: "_Tuple2",_0: "fullName",_1: $Json$Encode.string(info.fullName)}
                                         ,{ctor: "_Tuple2",_0: "href",_1: $Json$Encode.string(info.href)}
                                         ,{ctor: "_Tuple2",_0: "signature",_1: $Json$Encode.string(info.signature)}
                                         ,{ctor: "_Tuple2",_0: "comment",_1: $Json$Encode.string(info.comment)}]));
   };
   var Info = F5(function (a,b,c,d,e) {    return {name: a,fullName: b,href: c,signature: d,comment: e};});
   var moduleToDocs = F2(function (modul,_p0) {
      var _p1 = _p0;
      var dotToHyphen = function (string) {    return A2($String.map,function (c) {    return _U.eq(c,_U.chr(".")) ? _U.chr("-") : c;},string);};
      var urlTo = function (name) {
         return A2($Basics._op["++"],
         "http://package.elm-lang.org/packages/",
         A2($Basics._op["++"],modul.packageName,A2($Basics._op["++"],"/latest/",A2($Basics._op["++"],dotToHyphen(modul.name),A2($Basics._op["++"],"#",name)))));
      };
      var nameToPair = function (vname) {
         var name = vname.name;
         var fullName = A2($Basics._op["++"],modul.name,A2($Basics._op["++"],".",name));
         var info = A5(Info,name,fullName,urlTo(name),vname.signature,vname.comment);
         var localName = A2($Basics._op["++"],A2($Maybe.withDefault,modul.name,_p1.alias),A2($Basics._op["++"],".",name));
         var pairs = _U.list([{ctor: "_Tuple2",_0: localName,_1: info}]);
         var _p2 = _p1.exposed;
         switch (_p2.ctor)
         {case "None": return pairs;
            case "Some": return A2($Set.member,name,_p2._0) ? A2($List._op["::"],{ctor: "_Tuple2",_0: name,_1: info},pairs) : pairs;
            default: return A2($List._op["::"],{ctor: "_Tuple2",_0: name,_1: info},pairs);}
      };
      var typeToPair = F2(function (type$,tag) {
         var fullName = A2($Basics._op["++"],modul.name,A2($Basics._op["++"],".",tag));
         var info = A5(Info,tag,fullName,urlTo(type$),"","");
         return _U.list([{ctor: "_Tuple2",_0: tag,_1: info},{ctor: "_Tuple2",_0: fullName,_1: info}]);
      });
      return A2($Basics._op["++"],
      A2($List.concatMap,nameToPair,A2($Basics._op["++"],modul.values.aliases,modul.values.values)),
      A2($List.concatMap,function (_p3) {    var _p4 = _p3;return A2($List.concatMap,typeToPair(_p4._0),_p4._1);},modul.values.types));
   });
   var collate = F3(function (imports,moduleList,filterName) {
      var accept = function (_p5) {    var _p6 = _p5;return A2($String.startsWith,filterName,_p6._0) ? $Maybe.Just(_p6._1) : $Maybe.Nothing;};
      var getInfo = function (modul) {    return A2($Maybe.map,moduleToDocs(modul),A2($Dict.get,modul.name,imports));};
      return A2($List.filterMap,accept,$List.concat(A2($List.filterMap,getInfo,moduleList)));
   });
   var search = F3(function (query,source,docs) {
      var infos = A3(collate,$Import.parse(source),$Package.parse(docs),query);
      return A2($Json$Encode.encode,0,$Json$Encode.list(A2($List.map,encodeInfo,infos)));
   });
   return _elm.Oracle.values = {_op: _op,search: search,Info: Info,encodeInfo: encodeInfo,collate: collate,moduleToDocs: moduleToDocs};
};
Elm.Main = Elm.Main || {};
Elm.Main.make = function (_elm) {
   ...
   var withError = F2(function (task,error) {    return A2($Task.mapError,function (_p0) {    return error;},task);});
   var emitError = function (message) {
      var json = A2($Json$Encode.encode,
      0,
      $Json$Encode.list(_U.list([$Json$Encode.object(_U.list([{ctor: "_Tuple2",_0: "error",_1: $Json$Encode.string(message)}]))])));
      return $Console.fatal(json);
   };
   var getProjectDocs = function () {
      var path = $Path.resolve(_U.list(["elm-stuff","documentation.json"]));
      var generate = A2(withError,$Process.exec(A2($Basics._op["++"],"elm-make Main.elm --docs ",path)),"Failed to generate local project docs.");
      var load = A2(withError,$File.read(path),"Failed to load local project docs.");
      return A2($Task.andThen,
      generate,
      function (_p1) {
         return A2($Task.andThen,load,function (docs) {    return $Task.succeed(_U.list([{ctor: "_Tuple2",_0: path,_1: docs}]));});
      });
   }();
   ...
   $File.read($Path.resolve(_U.list(["elm-stuff","exact-dependencies.json"]))),
   "Dependencies file is missing. Perhaps you need to run `elm-package install`?");
   var loadSource = function (path) {
      return A2(withError,$File.read($Path.normalize(path)),A2($Basics._op["++"],"Could not find the give source file: ",path));
   };
   var Warn = function (a) {    return {ctor: "Warn",_0: a};};
