...
var _user$project$Main$modules = _elm_lang$core$Native_Platform.incomingPort('modules', _elm_lang$core$Json_Decode$string);
...
var _user$project$Main$Flags = F2(
	function (a, b) {
		return {file: a, query: b};
	});
var _user$project$Main$Module = function (a) {
	return {ctor: 'Module', _0: a};
};
var _user$project$Main$subscriptions = function (model) {
	return _user$project$Main$modules(_user$project$Main$Module);
};
var _user$project$Main$main = {
	...
	flags: A2(
		...
		function (file) {
			return A2(
				_elm_lang$core$Json_Decode$andThen,
				A2(_elm_lang$core$Json_Decode_ops[':='], 'query', _elm_lang$core$Json_Decode$string),
				function (query) {
